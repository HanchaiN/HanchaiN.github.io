import convert_color, { srgba2hex } from "@/utils/color/conversion.js";
import { getParentSize, startAnimationLoop } from "@/utils/dom/utils.js";
import { average, constrain, fpart, lerp, map } from "@/utils/math/utils.js";
        ...
        const SLIT_WIDTH =
          LAYER.SLIT_POSITION.length === 1
            ...
            : slitIndex === LAYER.SLIT_POSITION.length - 1
              ? (LAYER.SLIT_POSITION[slitIndex + 0]! -
