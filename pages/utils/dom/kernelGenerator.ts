import type { RGBAColor } from "../color/conversion.js";
import type { MutableTensor } from "../math/tensor.js";
...
>(
  ...
  return function* (
    ...
    IReturnType,
    MutableTensor<IReturnType, [typeof buffer.width, typeof buffer.height]>,
    undefined
  > {
    const res: MutableTensor<
      IReturnType,
      [typeof buffer.width, typeof buffer.height]
    > = new Array(this.output.x)
      .fill(null)
